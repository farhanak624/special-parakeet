...
var instance = new Razorpay({
    key_id: 'rzp_test_X5acYQdH4vfZBI',
    key_secret: '5ZotD1CKH1wlq4imWLHVwE9O',
  });
...
module.exports = {
    ...
    getUser:(userId)=>{
        return new Promise(async(resolve,reject)=>{
            let user= await db.get().collection(collections.USER_COLLECTION).findOne({user:objectId(userId)}).then(()=>{
                console.log("user detailss :",user);
                resolve(response)
            })
    ...
    verifyPayment:(details)=>{
        return new Promise ((resolve,reject)=>{
            ...
            let hmac = crypto.createHmac('sha256','5ZotD1CKH1wlq4imWLHVwE9O') 
